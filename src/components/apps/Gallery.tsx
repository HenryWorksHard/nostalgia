...
const coinCollection: CoinItem[] = [
  ...
  { id: '7', ticker: '$HAWK', name: 'Hawk Tuah', category: 'pump.fun Era', description: 'Hailey Welch "Hawk Tuah girl". Launched and rugged spectacularly. A cautionary tale.', image: 'https://dd.dexscreener.com/ds-data/tokens/solana/HAWKThXRcNLfhKuZqFhwCZPyYvK2nCqBjsdmMjdpump.png' },
  ...
  { id: '12', ticker: '$BODEN', name: 'Jeo Boden', category: 'Cult Plays', description: 'Biden political coin. Election season speculation.', image: 'https://dd.dexscreener.com/ds-data/tokens/solana/3psH1Mj1f7yUfaD5gh6Zj7epE8hhrMkMETgv5TshQA4d.png' },
  ...
  { id: '14', ticker: '$BRETT', name: 'Brett', category: 'Cult Plays', description: "Boy's Club character. Bigger on Base but Solana had its version too.", image: 'https://dd.dexscreener.com/ds-data/tokens/solana/BRETTqYJxZ5McFja8NB5jL4XeF7XYTwkRange4QHMGh.png' },
]
